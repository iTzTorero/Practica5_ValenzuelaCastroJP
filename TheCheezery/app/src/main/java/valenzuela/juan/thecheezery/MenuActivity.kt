...
class MenuActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnHot: Button = findViewById(R.id.button_cold_drinks) as Button
        var btnSweets: Button = findViewById(R.id.button_cold_drinks) as Button
        var btnSalties: Button = findViewById(R.id.button_cold_drinks) as Button
